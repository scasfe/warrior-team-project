...
public class ContextLoader {
	 ...
	 */
	private static final String DEFAULT_STRATEGIES_PATH = "/usr/local/tomcat/config/wt-external-properties.properties";
	private static final String DEVPT_STRATEGIES_PATH = "d:/wt-external-properties.properties";
	...
	private void createWebApplicationProperties() {
		try {
			...
			logger.debug("Context initialization failed with default, trying second DEVPT");
			try {
