...
public class WTAjoutCommentaireDialogBox {
	...
	/**
	 * Instance singleton c�t� client donc constructeur private
	 */
	...
	private static void setup() {
		...
		// Ajout du click handler sur le bouton cr�ation
		...
		fileUploadServiceImpl.addCommentaire(commentaireInput.getText(),
				imageName, new WTModalAsyncCallback<String[]>() {
					...
					public void handleResult(String[] result) {
						...
						// S'il y a eu un commentaire d'ajout�
						if (result.length > 1) {
							// Mise � jour dynamique du commentaire
